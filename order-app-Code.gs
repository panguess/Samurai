 ...
 * รวมถึงตอน auto-refresh ฝั่งแอดมิน (ทุก 30 วิ) และฝั่งลูกค้าหน้าติดตามสถานะ (ทุก 10 วิ)
 * -> อ่านทั้งชีตซ้ำๆ โดยไม่จำเป็น ทำให้ยิ่งออเดอร์สะสมเยอะ ยิ่งช้าลงเรื่อยๆ
 *
 ...
 *   -> TTL ด้านล่างจึงกำหนดแค่ "นานสุดที่ข้อมูลจะเก่าได้ระหว่างไม่มีใครเขียนอะไรเลย" ไม่กระทบความสดของ
 *   ข้อมูลตอนมีคนกดปุ่มจริงในแอปเลย
 ...
 *
 * [แก้ 15 ก.ย. 69] เดิม TTL 10 วิ สั้นกว่ารอบ auto-refresh ฝั่งแอดมิน (30 วิ) มาก ทำให้ cache หมดอายุ
